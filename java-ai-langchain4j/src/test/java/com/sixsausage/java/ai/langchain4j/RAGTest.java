...
@SpringBootTest(classes = {RAGTest.class})
...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        Document document0 = FileSystemDocumentLoader.loadDocument("E:/knowledge/测试.txt");
...
//自定义文档分割器
//按段落分割文档：每个片段包含不超过 300个token ，并且有 30个token的重叠部分保证连贯性 //注意：当段落长度总和小于设定的最大长度时，就不会有重叠的必要。
